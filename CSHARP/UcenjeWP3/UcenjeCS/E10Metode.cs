...
namespace UcenjeCS
{
    internal class E10Metode
    {
        ...
        // naziv metoda ne mora biti jedinstven
        ...
        // TIP 4. NAJBITNIJA metoda prima parametre, metoda vraća vrijednost
        // protected je vidljiv u ovoj klasi i svim podklasama (OOP-kasnije)
        /// <summary>
        /// Primjer metoda koja prima dva parametra i vraća vrijednost
        /// </summary>
        /// <param name="odBroja">Prvi primljeni parametar od kojega se kreće</param>
        /// <param name="doBroja">Drugi primljeni parametar do kojeg se ide(<=)</param>
        /// <returns>Zbroj svakog drugog broja između dva priljena</returns>
