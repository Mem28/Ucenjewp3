...
select * from authors where city like '%a%' and zip > 90000;

select * from authors where au_fname like '%s' and address like '%c%';

select* from authors where address not like '%h%' order by au_lname;

select* from authors where city not like '%a%' order by zip;

select*from authors order by au_id;

select top 5* from authors where au_fname like '%i%' and city not like '%c%';


select * from discounts;

select * from discounts where discount <7;

select * from discounts where stor_id like 8042;
...
select *from employee where fname not like '%k%';

select top 20* from employee where minit not like '%m%' and job_lvl<100;

select getdate()

select * from employee where job_id > 5 and fname not like '%a%' order by job_lvl desc;

select top 30* from employee where job_lvl>50 order by fname desc;

select * from employee where minit like 's%' order by hire_date;



select * from jobs;

select top 10* from jobs where max_lvl not like 100 and job_id <14 order by min_lvl desc;

select * from jobs where job_desc like '%d%' and min_lvl >50;

select top 15* from jobs order by max_lvl;



select * from pub_info;

select * from pub_info where pr_info like '%as%' and pub_id <1000;


select * from publishers;

select * from publishers where city not like '%os%' and country like '%usa%' order by pub_id;

select top 3* from publishers where pub_name not like '%o%' and city not like '%w%' order by country desc;


select * from roysched;

select top 50* from roysched where hirange >5000 and lorange not like 0 order by title_id;

select * from roysched where hirange = 50000 and royalty > 20 order by lorange;


select * from sales;

select*from sales where qty <30 and ord_num not like '%1%' order by ord_date;


select* from stores;

select * from stores where city not like '%o%' and zip <95000 and state like '%a%' order by stor_name desc;

select top 3* from stores where zip>92500;


select*from titleauthor;

select * from titleauthor where au_ord >1 and royaltyper <100 and title_id like'%tc%' order by au_id;


select * from titles;

select * from titles where type not like '%business%' and advance >2500 and 
title not like '%us%' and notes like '%o%' and pub_id <1000 and price >14 order by pubdate desc;
