...
select top 10* from kokteli where naziv not like '%p%' order by naziv desc;

select* from kokteli where sifra >5 and naziv like '%a%' order by sifra;


select * from sastojci;

select * from sastojci where vrsta like 'alk%' and naziv not like '%sok%' order by sifra desc;

select top 3* from sastojci where naziv not like '%rum%' and vrsta like '%a%' order by naziv;

select * from sastojci where naziv like '%r%' and sifra>9 and vrsta not like '%s%' order by sifra;


select * from stavke;

select top 10* from stavke where normativ not like '%3cl%' and koktel not like 5 order by sastojak;

select * from stavke where koktel like 4 and normativ < '5cl' order by sastojak;

select*from stavke where koktel > 10 and sastojak not like 11 and normativ > '3cl' order by koktel;